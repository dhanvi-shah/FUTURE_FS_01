    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative">
          <div className="absolute left-5 top-0 bottom-0 w-px bg-gradient-to-b from-emerald-500/50 via-cyan-500/30 to-transparent md:left-1/2 md:-translate-x-px" />
          ...
          {experiences.map((exp, index) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={cn(
                    "absolute left-5 z-10 flex h-10 w-10 -translate-x-1/2 items-center justify-center overflow-hidden rounded-full border-2 bg-black md:left-1/2",
                    exp.highlight
                      ? "border-emerald-500"
                      : "border-emerald-500/80",
                    exp.logo && "bg-white p-1"
                  )}
                >
                  {exp.logo ? (
                    <Image
